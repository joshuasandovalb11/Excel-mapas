                  ...
                  <div className="pt-4 2xl:pt-5 border-t border-gray-200 space-y-4 2xl:space-y-5">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 2xl:gap-3">
                        ...
                        <button
                          onClick={() =>
                            updateParams({ minStopDuration: String(Math.min(120, minStopDuration + 1)) })
                          }
                          className="p-1 bg-white border border-gray-200 rounded shadow-sm text-gray-500 hover:text-black hover:border-gray-300 transition-all"
                        >
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 2xl:gap-3">
                        <button
                          onClick={() =>
                            updateParams({ clientRadius: String(Math.max(10, clientRadius - 10)) })
                          }
                          className="p-1 bg-white border border-gray-200 rounded shadow-sm text-gray-500 hover:text-black hover:border-gray-300 transition-all"
                        >
                          <Minus className="w-3 h-3" />
                        ...
                        <input
                          ...
                          value={clientRadius}
                          onChange={(e) =>
                            updateParams({ clientRadius: e.target.value })
                          }
                          className="flex-1 h-1 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-blue-600"
                        />
                        <button
                          onClick={() =>
                            updateParams({ clientRadius: String(Math.min(1000, clientRadius + 10)) })
                          }
                          className="p-1 bg-white border border-gray-200 rounded shadow-sm text-gray-500 hover:text-black hover:border-gray-300 transition-all"
                        >
                          <Plus className="w-3 h-3" />
